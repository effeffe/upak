C$PROG SLICIB    - Returns slices of 2-D data for COPAD & SLOUT
C
C     ******************************************************************
C     BY WT MILNER AT HRIBF - LAST MODIFIED 04/17/02
C     ******************************************************************
C
      SUBROUTINE SLICIB(LUD,LUH,ID,IY,IDAT,IERR)
C
...
C
      integer*4    jsixteenbits
C   
      EQUIVALENCE (JDATF(1),IDATF(16385))
C
