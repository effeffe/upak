C$PROG DDAT      - Displays buffer data in various formats for SCANOR
C
C     ******************************************************************
...
C
      INTEGER*2    XFFFF,X2020,X0000
C
      DATA         XFFFF,X2020,X0000/Z'FFFF',Z'2020',Z'0000'/
C
...
C
      CHARACTER*4  KMD
C
      INTEGER*4    ILO,IHI,JLO,JHI,IA,IB,NM1,NPARR,NUM,N,I
C
      EQUIVALENCE (JBUF,LIST),(IBUF,LIST)
C     ------------------------------------------------------------------
      SAVE
C     ------------------------------------------------------------------
C
